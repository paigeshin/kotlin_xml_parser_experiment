...
import com.paigesoftware.xmlretrofitwithtikaroo.model.Channel
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RetrofitClient.instance.fetchKoreanTranslation("BE6CE91A004B80A221AC34965EE90F3E" , word = "안녕", translated = "y", trans_lang = 3).enqueue(object:
            Callback<Channel> {
